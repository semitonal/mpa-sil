...
extern byte spell_desire_RF4[32][3];
...
extern int get_noise_dist(byte which_flow, int y, int x);
extern void update_noise(int cy, int cx, byte which_flow);
...
extern void make_aggressive(void);
