...
extern bool place_monster_one(int y, int x, int r_idx, bool slp, bool ignore_depth, monster_type *m_ptr);
extern bool place_monster_aux(int y, int x, int r_idx, bool slp, bool grp, bool ignore_depth);
